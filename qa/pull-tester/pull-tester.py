#!/usr/bin/python
# Copyright (c) 2013 The Urals Core developers
...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old UralsPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/UralsdComparisonTool_jar/UralsdComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/urals/urals.git")
...
environ_default("BUILD_PATH", "/mnt/urals")
...
environ_default("GITHUB_REPO", "urals/urals")
