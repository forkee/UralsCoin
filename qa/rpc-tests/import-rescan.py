...
import RPC call and node 0 sends BSD to it. Then other nodes import the
...
In the second part of the test, node 0 sends more BSD to each address, and the
...
class ImportRescanTest(UralsTestFramework):
    def __init__(self):
        super().__init__()
