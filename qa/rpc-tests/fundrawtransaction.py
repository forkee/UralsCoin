...
class RawTransactionsTest(UralsTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid urals address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid urals address" in e.error['message'])
