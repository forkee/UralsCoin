...
class WalletTest (UralsTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 BSD from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BSD with subtract fee from amount
        ...
        # Sendmany 10 BSD with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/urals/urals/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
