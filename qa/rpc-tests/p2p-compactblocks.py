...
# TestNode: A peer we use to send messages to uralsd, and store responses.
...
class CompactBlocksTest(UralsTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes uralsd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that uralsd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for uralsd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # uralsd will not send blocktxn responses for blocks whose height is
