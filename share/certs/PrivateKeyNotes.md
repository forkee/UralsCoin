...
unlocked to sign the Bitsend-Qt.app bundle.
...
allowing somebody to distribute a Bitsend-Qt.app or urals-qt-setup.exe with a valid
...
that the urals-qt.exe file inside the installer had not been tampered with.
