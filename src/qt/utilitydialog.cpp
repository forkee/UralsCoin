    ...
    ui(new Ui::AboutDialog)
{
    ...
    ui->copyrightLabel->setText(tr("Copyright") + QString(" &copy; 2009-%1 ").arg(COPYRIGHT_YEAR) + tr("The Bitcoin and Dash Core developers") + QString("<br />")
                                 ...
                                 + tr("Copyright") + QString(" &copy; 2014-%1 ").arg(COPYRIGHT_YEAR) + tr("The URALS Core developers."));
}
...
/** "PaperWallet" dialog box Uralsdev 28-04-2015 */
...
void PaperWalletDialog::on_printButton_clicked()
{
    ...
    while( true ) {
        ...
        double amountInput = QInputDialog::getDouble(this, tr("Load Paper Wallets"), tr("Please wait for wallets to print and verify readability.<br/>Enter the number of URALS you wish to send to each wallet:"), 0, 0, 2147483647, 8, &ok);
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("Urals Core") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  urals-qt [" + tr("command-line options") + "]                     " + "\n";
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("Urals Core is shutting down...") + "<br /><br />" +
