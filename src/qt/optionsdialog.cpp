    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Blue arrow"), QVariant("urals_main"));
    ui->theme->addItem(QString("Linux red"), QVariant("urals_theme1"));
    ui->theme->addItem(QString("Blue City Sky"), QVariant("urals_theme2"));
	ui->theme->addItem(QString("Lambo Car"), QVariant("urals_theme3"));
