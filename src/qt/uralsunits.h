...
#ifndef URALS_QT_URALSUNITS_H
#define URALS_QT_URALSUNITS_H
...
/** Urals unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UralsUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit UralsUnits(QObject *parent);

    /** Urals units.
      @note Source: https://en.urals.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BsD,
...
typedef UralsUnits::Unit UralsUnit;

#endif // URALS_QT_URALSUNITS_H
