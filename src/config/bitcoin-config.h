/* src/config/urals-config.h.  Generated from urals-config.h.in by configure.  */
/* src/config/urals-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef URALS_CONFIG_H

#define URALS_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Urals Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Urals Core"
...
#define PACKAGE_BUGREPORT "https://github.com/JohnMnemonick/UralsCoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Urals Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Urals Core 0.14.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "urals"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://uralscoin.info/"
