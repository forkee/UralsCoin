...
#ifndef URALS_VALIDATION_H
#define URALS_VALIDATION_H
...
CAmount GetBlockSubsidy(int nBits, int nHeight, const Consensus::Params& consensusParams);//TODO-- added bits
