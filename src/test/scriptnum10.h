...
#ifndef URALS_TEST_SCRIPTNUM10_H
#define URALS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Urals Core 0.10.0, for cross-comparison.
 */
public:
