...
CONFIG_HEADER = $(top_builddir)/src/urals-config.h
...
QR_CFLAGS = 
QR_LIBS = -lqrencode
QT_CFLAGS = -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/x86_64-linux-gnu/qt5
...
QT_INCLUDES = -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/x86_64-linux-gnu/qt5
QT_LDFLAGS = 
...
abs_builddir = /home/wizard/UralsCoin
abs_srcdir = /home/wizard/UralsCoin
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/uralsd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/urals-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/urals-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Urals-Qt.app
OSX_DMG = Urals-Qt.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_urals_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_urals_coverage.info test_urals.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Urals-Qt
...
$(OSX_APP)/Contents/MacOS/Urals-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(OSX_DMG): $(OSX_APP_BUILT) $(OSX_PACKAGING)
	...
	$(GENISOIMAGE) -no-cache-inodes -l -probe -V "Urals-Qt" -no-pad -r -apple -o $@ dist
...
#test_urals.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_urals -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_urals_filtered.info: test_urals.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_urals_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_urals_coverage.info: baseline_filtered_combined.info test_urals_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_urals_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_urals_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_urals_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_urals.coverage/.dirstamp:  test_urals_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_urals.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_urals.coverage/ total.coverage/ $(OSX_APP)
