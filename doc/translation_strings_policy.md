...
This document provides guidelines for internationalization of the Urals Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `urals_en.ts` remains unchanged.
