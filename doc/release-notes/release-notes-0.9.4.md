Urals Core version 0.9.4 is now available from:

  https://urals.org/bin/0.9.4/
...
this update is incompatible with the Urals system and could lead to consensus
forks.

Urals Core released binaries from https://urals.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~urals/+archive/ubuntu/urals
- A third-party or self-compiled Urals Core

upgrade to Urals Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
