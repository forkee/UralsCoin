...
Urals Core 0.11.0 is forked off the Urals Core 0.9.3. The old urals
...
notes of Urals Core  0.9.0, 0.9.1, 0.9.2, 0.9.2.1, 0.9.3 and was completed
with the  introduced changes to the Urals Core 0.11.0.
