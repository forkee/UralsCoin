Urals-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/urals/files/Urals/urals-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Urals
...
New/changed settings (command-line or urals.conf file)
--------------------------------------------------------
