Urals Core version 0.13.2 is now available from:

  <https://urals.org/bin/urals-core-0.13.2/>
...
- #8908 `4a974b2` Update urals-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow urals-tx to create v2 transactions (btcdrak)
