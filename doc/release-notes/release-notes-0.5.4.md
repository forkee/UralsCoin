Urals version 0.5.4 is now available for download at:
http://sourceforge.net/projects/urals/files/Urals/urals-0.5.4/
...
http://gitorious.org/urals/uralsd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Urals-Qt notifications under Growl 1.3.
Increase required age of Urals-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxUrals properly when installing Urals-Qt over it. (Windows)
