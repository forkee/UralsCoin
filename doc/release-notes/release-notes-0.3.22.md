Download URL: https://sourceforge.net/projects/urals/files/Urals/urals-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BSD fee schedule (users still pay 0.01 BSD per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #urals00 - #urals99
