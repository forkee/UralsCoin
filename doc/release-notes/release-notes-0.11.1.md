...
Urals Core 0.11.1 supports a full implementation of InstantX, Darksend improvements
and a new version of enforcement compatible with the newer Urals architechure.
...
- fix coin control crash https://github.com/urals/urals/pull/5700
